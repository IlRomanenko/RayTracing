...
void initRayCasting() {
    ...
    MyParser parser(materialsFactory, viewport, lights, geometry);
    parser.openScene("buggy.irt", "examples/");
...
void keyboardFunc(unsigned char chr, int, int) {
    ...
    glutPostWindowRedisplay(test_kd_window);
}
...
int main(int argc, char **argv) {
    ...
    test_kd_window = glutCreateWindow("Ray-tracing by Ilya Romanenko");
